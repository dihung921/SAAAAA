                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                      while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "
                                              ...
                                              <td>".$row["note"]."</td>
                                              <td>
                                                <a href='down.php?meal_id=".$row["meal_id"]."&& price=".$row["price"]."' style='background: #d4d768; padding: 6.3px 16px 6.3px 16px; border-radius: 30px; border: 1px solid; border-color:#d4d768'>-</a>&nbsp
